...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Record.laminate'
        db.add_column('record_record', 'laminate', self.gf('django.db.models.fields.BooleanField')(default=False, blank=True), keep_default=False)
    
    
    def backwards(self, orm):
        
        # Deleting field 'Record.laminate'
        db.delete_column('record_record', 'laminate')
