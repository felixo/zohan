...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Record.email'
        db.add_column('record_record', 'email', self.gf('django.db.models.fields.TextField')(default='', max_length=128), keep_default=False)
    
    
    def backwards(self, orm):
        
        # Deleting field 'Record.email'
        db.delete_column('record_record', 'email')
    ...
    models = {
        ...
        'record.record': {
            ...
            'email': ('django.db.models.fields.TextField', [], {'max_length': '128'}),
